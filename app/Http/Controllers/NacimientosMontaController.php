...
class NacimientosMontaController extends Controller
{
    private $cliente;
    ...
    {
        $respuesta = $this->cliente->get('nacimientos_monta');
        $cuerpo = $respuesta->getBody();
  

          return view('nacimientos_monta.index', ['nacimientosmonta' => json_decode($cuerpo)]);
    }
    ...
    public function create()
    {
        ...
        $cuerpo3 = $respuesta3->getBody();
         ...
         $respuesta4 = $this->cliente->get('recien-paridas-monta');
        ...
        return view('nacimientos_monta.create',['datos' => $datos]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->cliente->post('registrar-nacimiento-monta',['json'=> $request->all()]);
        return redirect()->route('nacimientos_monta.index')->with('edit', 'Nacimiento por Monta de toros registrado. Vaya y actualice el campo de esta vaca, por PARIDA');
    }
