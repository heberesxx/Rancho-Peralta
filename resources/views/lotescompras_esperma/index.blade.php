...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Lotes de Compras de Esperma</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('lotescompras_esperma.pdf')}}" class="btn btn-danger" style=" margin-left: 5%;">
                ...
                <div class="card-body">
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center" style="position:center; width:10%;"> {{ $lote->COD_COMPRA_ESPERMA }}</td>
                                ...
                                <td style="width:auto; text-align: right;">{{ $lote->TOTAL_PRECIO }}</td>
