...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Lotes de Compra de Esperma</title>
...
<body>
    <header class="clearfix">
       <div id="logo">
        ...
        <h1>Lotes de Compra de Esperma</h1>
        ...
        <table >
            <thead >
                <tr>
                    ...
                    <th class="desc">Cantidad Pajillas</th>
                    <th class="desc">Total (L)</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="desc"> {{ $lote->COD_COMPRA_ESPERMA }}</td>
