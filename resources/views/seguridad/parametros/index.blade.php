...
Pantalla:          Parámetros de Seguridad
Fecha:             25/02/2022
Programador:       Heber Espinoza
descripción:       Pantalla que permite vizualizar los Parámetros de Seguridad 
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('seguridad.parametros.pdf')}}" class="btn btn-danger center" target="_blank" style=" margin-left: 35%;">
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-center">{{\Carbon\Carbon::parse( $parametro->created_at)->format('d-m-Y H:i:s') }}</td>
                                <td class="text-center">{{\Carbon\Carbon::parse( $parametro->updated_at)->format('d-m-Y H:i:s') }}</td>
                                @CAN('EDITAR_PARAMETROS')
                                <td>
