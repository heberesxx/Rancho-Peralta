...
descripción:       Pantalla que permite vizualizar los Objetos del Sistema
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                @can('EDITAR_OBJETOS')
                                <td><a href="{{route('objetos.edit', $objeto->id)}}" class="btn btn-warning btn-sm fa fa-edit "></a></td>
                                @ENDCAN
                                @can('ELIMINAR_OBJETOS')
                                <td>
