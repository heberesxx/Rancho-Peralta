...
Pantalla:          Compras Esperma
Fecha:             24/03/2022
Programador:       Jeffry Aguilar
descripción:       Pantalla que permite visualizar el detalle de los lotes de compras de esperma.


-->
@extends('adminlte::page')

@section('title', 'Compras Esperma')
			...
			<div class="card">
				...
				<div class="card-header">
					<div class="box-header">
						...
						<a href="{{route('esperma.pdf')}}" class="btn btn-danger" target="_blank" style=" margin-left: 26%;">
							...
							<table id="TB" class="table table-bordered table-hover US">
								...
								<tbody>
									...
									<tr>
										...
										<td style="text-align: right;">{{ number_format($esperma->PRE_ESPERMA, 2, '.',',') }}</td>
