...
Pantalla:          Detalles Lote Ganado
Fecha:             23/03/2022
Programador:       Jeffry Aguilar
descripción:       Pantalla que permite visualizar  el detalle de un lote de compras de ganado.


-->
@extends('adminlte::page')
@CAN('VER_LOTES GANADO')
@section('title', 'Detalles Lote Ganado')
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">{{ $lote->PRE_GANADO }}</td>
                                <td class="text-center">{{ $lote->DET_ESTADO }}</td>
                                <td class="text-center">{{ $lote->DIR_LUGAR }}</td>
