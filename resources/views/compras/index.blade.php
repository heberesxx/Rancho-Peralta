...
Pantalla:          Compras Ganado
Fecha:             20/03/2022
Programador:       Jeffry Aguilar
descripción:       Pantalla que permite visualizar el detalle de los lotes de compras de ganado.
            ...
            @can('INSERTAR_LOTES GANADO')
                <div class="card-header">
                    <div class="box-header">
                        ...
                        <a href="{{route('compras.pdf')}}" class="btn btn-danger glyphicon glyphicon-duplicate " target="_blank" style="margin-left :31%;">
