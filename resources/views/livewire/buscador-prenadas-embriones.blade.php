<div>
        ...
        <div class="modal-dialog " role="document" height="50%">
            <div class="modal-content ">
                <div class="modal-header text-center">
                    <h5 class="modal-title-center text-center" id="exampleModalLabel">BUSCAR RECIÉN PARIDA
                    </h5>
                ...
                <div class="px-2">
                    ...
                    <table class="table table-sm table-bordered table-condensed table-hover">
                        ...
                        <tbody>
                            @foreach($vacaspe as $vacape)
                            <tr>
                                <td class="text-center"  style="width: 10px;"><input wire:model="selected_vacaspe" name="COD_PRENADA_EMBRION" type="radio" value="{{$vacape->COD_PRENADA_EMBRION}}" /></td>
                                <td>{{ 'Nombre: '.$vacape->NOM_GANADO. ', Arete N°: '.$vacape->NUM_ARETE}}</td>
    ...
    <div class="form-group">
        <label><span style="color: red;">*</span>Vaca Parto:</label>
        <div class="input-group-prepend">
            <input id="COD_PRENADA_EMBRION" class="form-control border-dark" hidden placeholder="Ingrese la cantidad comprada..." type="text" name="COD_PRENADA_EMBRION" value="{{$selected_vacaspe}}" autofocus>
