...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>Lotes de Venta de Ganado</title>
...
<body>
    <header class="clearfix">
       <div id="logo">
        ...
        <h1>Lotes de Venta de Ganado</h1>
        ...
        <table >
            <thead >
                <tr>
                    ...
                    <th class="desc">Fecha de Venta</th>
                    <th class="desc" >Cliente</th>
                    <th class="desc" >Cantidad Vendida</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="desc" > {{ $lote->COD_VENTA }}</td>
                    <td class="desc" >{{ $lote->FEC_VENTA }}</td>
                    <td class="desc" >{{ $lote->CLIENTE }}</td>
