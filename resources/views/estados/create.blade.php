...
Pantalla:            Crear Estado
Fecha:             01/03/2022
Programador:       Heber Espinoza
descripción:       Pantalla que permite  crear  un estado 
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="DET_ESTADO" placeholder=""  value="{{old('DET_ESTADO')}}" id="DET_ESTADO" maxlength="30" minlength="2" title="Este campo solo permite letras,30 carácteres como máximo y 2 como mínimo"  class="form-control" type="text" value="{{ old('DET_ESTADO') }}" onkeyup="javascript:this.value=this.value.toUpperCase();" >
