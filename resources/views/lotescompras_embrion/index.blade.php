            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('lotescompras_embrion.pdf')}}" class="btn btn-danger " style=" margin-left: 5%;">
                ...
                <div class="card-body">
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center" style="position:center; width:10%;"> {{ $lote->COD_COMPRA_EMBRION }}</td>
