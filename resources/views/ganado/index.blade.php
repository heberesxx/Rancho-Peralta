...
Pantalla:          Ganado Registrado
Fecha:             01/02/2022
Programador:       Heber Espinoza
descripción:       Pantalla que permite vizualizar el Ganado Registrado 
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('ganado.pdf')}}" class="btn btn-danger center" target="_blank" style=" margin-left: 36.5%;">
