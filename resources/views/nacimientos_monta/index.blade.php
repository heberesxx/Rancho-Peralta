...
Pantalla:          Nacimientos Monta
Fecha:             03/02/2022
Programador:       Jennifer Claros
descripción:       Pantalla que permite visualizar todos los nacimientos por medio de monta de toro.
 -->


@extends('adminlte::page')

@section('title', 'Nacimientos Monta')
@can('VER_NACIMIENTOS MONTA')
@section('content_header')
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Nacimientos por Monta de Toros</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('nacimientos_monta.create')}}" class="btn btn-info">
                            <span class="mr-2">Registrar Nacimiento</span> <i class="fas fa-plus-square"></i>
                        </a>

                        <a href="{{route('nacimientos_monta.pdf')}}" class="btn btn-danger center" target="_blank"
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{'Nombre: '.$nacimientomonta->NOM_GANADO.', Arete: '.$nacimientomonta->ARETE_VACA.', Color: '.$nacimientomonta->COLOR_GANADO.', Edad: '.$nacimientomonta->EDAD_GANADO.' años'}}</td>
                                <td class="text-center">{{ \Carbon\Carbon::parse($nacimientomonta->FEC_NACIMIENTO)->format('d-m-Y')}}</td>
                                <!-- @can('EDITAR_NACIMIENTOS MONTA')
                                <td class="text-center" colspan="2">

                                    <a class="btn btn-warning" href=" {{ url('nacimientos_monta/' .$nacimientomonta->COD_NACIMIENTO_MONTA . '/edit') }}">Editar</a>
                                </td>
                                @ENDCAN -->
                            </tr>
                            @endforeach
