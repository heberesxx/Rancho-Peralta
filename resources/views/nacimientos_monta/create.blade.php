...
<div class="container-fluid">
    <div class="row">
        ...
        <h3 class="text-center" style="margin-left: 550px;">Registrar Nacimiento por Monta</h3>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12 mb-2">
                        <a href="{{ route('nacimientos_monta.index') }}" class="btn btn-danger w-100">Cancelar <i class="fa fa-times-circle ml-2"></i>
                        </a>
                    </div>
