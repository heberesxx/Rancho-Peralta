	...
	<main>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					<td class="desc">{{$i}}</td>
					<td class="desc">{{ $compra->COD_COMPRA_GANADO}}</td>
					<td class="desc">{{ \Carbon\Carbon::parse($compra->FEC_COMPRA)->format('d-m-Y')}}</td>
					<td class="desc">{{ $compra->PERSONA}}</td>
					<td class="desc">{{ $compra->PRECIO}}</td>
					<td class="desc">{{ $compra->NOM_GANADO}}</td>
