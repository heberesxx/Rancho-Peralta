...
Pantalla:            Razas Ganado
Fecha:             01/03/2022
Programador:       Heber Espinoza
descripción:       Pantalla que permite vizualizar las Razas del Ganado 
            ...
            @CAN('INSERTAR_RAZAS')
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('razas.pdf')}}" class="btn btn-danger center" target="_blank"
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @CAN('EDITAR_RAZAS')
                                <td class="text-center"><a class="btn btn-warning btn-sm fa fa-edit "  href="{{ route('razas.edit', $raza->COD_RAZA) }}"></a></td>
                               @ENDCAN
                            </tr>
                            @endforeach
                        </tbody>
