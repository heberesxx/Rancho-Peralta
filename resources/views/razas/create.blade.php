...
descripción:       Pantalla que permite  crear  una Raza 
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="NOM_RAZA" placeholder="" id="NOM_RAZA" class="form-control"    type="text" maxlength="30" minlength="2" title="Este campo solo permite letras mayúsculas,30 carácteres como máximo y 2 como mínimo" onkeyup="javascript:this.value=this.value.toUpperCase();">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label><span style="color: red;"> </span>Descripción Raza</label>
