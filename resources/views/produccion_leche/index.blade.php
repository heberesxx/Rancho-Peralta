...
Pantalla:          Producción de Leche
Fecha:             02/02/2022
Programador:       Nancy Domínguez
descripción:       Pantalla que permite visualizar la Producción de Leche registrada
--->
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('produccion_leche.pdf')}}"  target="_blank" class="btn btn-danger text-center" style=" margin-left: 35%;">
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{'Nombre: '.$produccion_leche->NOM_GANADO.', Arete: '.$produccion_leche->ARETE.', Color: '.$produccion_leche->COLOR.', Edad: '.$produccion_leche->EDAD_GANADO.' años'}}</td>
