...
Pantalla:          Registrar Transferencia Esperma
Fecha:             01/02/2022
Programador:       Heber Espinoza
descripción:       Pantalla que permite registrar una transferencia de Esperma.
...
@section('title', 'Registrar Transferencia Esperma')
@can('INSERTAR_TRANSFERENCIAS ESPERMA')
@section('content_header')
<div class="container-fluid">
    <div class="row">

        <h3 class="text-center" style="margin-left: 550px;">Nueva Transferencia de Esperma</h3>
...
<div class="container-fluid col-md-9">
    ...
    <div class="card card-info">
        ...
        <form action="{{route('transesperma.store')}}" method="post">
            @csrf()
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label>Estado</label>
                            <select name="IND_TRANS_ESPERMA" class="form-control" id="IND_TRANS_ESPERMA" disabled>
