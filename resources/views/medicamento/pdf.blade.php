        ...
        <table >
            <thead >
                <tr>
                    ...
                    <th class="desc">Dosis</th>
                    <th class="desc">Cantidad</th>
                    <th class="desc">Reorden</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="desc">{{$medicamento->COD_MEDICAMENTO}}</td>
                    <td class="desc">{{$medicamento->NOM_MEDICAMENTO}}</td>
                    <td class="desc">{{$medicamento->ADM_MEDICAMENTO}}</td>
                    <td class="desc">{{$medicamento->TRA_MEDICAMENTO}}</td>
                    <td class="desc">{{$medicamento->DOS_MEDICAMENTO}}</td>
                    <td class="desc">{{$medicamento->CAN_DISPONIBLE}}</td>
                    <td class="desc">{{$medicamento->CAN_REORDEN}}</td>
