...
Pantalla:          Registrar Nacimiento Embrión
Fecha:             03/02/2022
Programador:       Jennifer Claros
descripción:       Pantalla que permite crear un nuevo registro de nacimiento por medio de transferencias de embriones. -->

@extends('adminlte::page')

@section('title', 'Registrar Nacimiento Embrión')
@can('INSERTAR_NACIMIENTOS EMBRION')
@section('content_header')
<div class="container-fluid">
    <div class="row">

        <h3 class="text-center" style="margin-left: 550px;">Registrar Nacimiento por Embrión</h3>
...
<div class="container-fluid col-md-11">
    ...
    <div class="card card-info">
        ...
        <form action="{{ route('nacimientos.store') }}" method="post" role="form">
            @csrf()
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input name="CLR_GANADO" placeholder="" id="CLR_GANADO" class="form-control border-dark" title="Este campo solo acepta letras" type="text" value="{{old('CLR_GANADO')}}"  minlength="2" maxlength="30" pattern="[A-Za-zÀ-ÿ ]{2,30}" title="Este campo solo puede contener letras y espacios">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            @livewire('buscador-prenadas-embriones')
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12 mb-2">
                        <a href="{{ route('nacimientos.index') }}" class="btn btn-danger w-100">Cancelar <i class="fa fa-times-circle ml-2"></i>
                        </a>
                    </div>
