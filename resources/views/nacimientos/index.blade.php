...
Pantalla:          Nacimientos Embriones
Fecha:             03/02/2022
Programador:       Jennifer Claros
descripción:       Pantalla que permite visualizar todos los nacimientos por medio de transferencias de embriones.
 -->
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('nacimientos.pdf')}}" class="btn btn-danger center" target="_blank"
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{'Nombre: '.$nacimiento->NOM_GANADO.', Arete: '.$nacimiento->ARETE_VACA.', Color: '.$nacimiento->COLOR_GANADO.', Edad: '.$nacimiento->EDAD_GANADO.' años'}}</td>
