            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="box-header">
                        ...
                        <a href="{{route('nacimientos_esperma.pdf')}}" class="btn btn-danger center" target="_blank"
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{'Nombre: '.$nacimientoesperma->NOM_GANADO.', Arete: '.$nacimientoesperma->ARETE_VACA.', Color: '.$nacimientoesperma->COLOR_GANADO.', Edad: '.$nacimientoesperma->EDAD_GANADO.' años'}}</td>
