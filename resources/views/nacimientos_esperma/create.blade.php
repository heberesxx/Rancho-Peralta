...
Pantalla:          Registrar Nacimiento Esperma
Fecha:             03/02/2022
Programador:       Jennifer Claros
descripción:       Pantalla que permite crear un nuevo registro de nacimiento por medio de transferencias de esperma.
 -->

@extends('adminlte::page')

@section('title', 'Registrar Nacimiento Esperma ')
