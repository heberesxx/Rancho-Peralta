...
descripción:       Pantalla que permite editar datos de las vacas preñadas por medio de transferencias de esperma.
 -->
...
<div class="container-fluid">
    <div class="row">
        ...
        <h3 class="text-center" style="margin-left: 550px;">Editar Vaca Preñada por Esperma</h3>
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input name="COD_VACA_PRENADA" value="{{$vacaprenadaesperma->COD_PRENADA_ESPERMA}}" placeholder="" id="COD_VACA_PRENADA" class="form-control" type="text" disabled>
                        </div>
                    </div>

                    <div class="col-lg-1">
                        <label><span style="color: red;"> * </span>N°Pajilla</label>
                        <input name="NUM_PAJILLA" value="{{$vacaprenadaesperma->NUM_PAJILLA}}" placeholder="" id="NUM_PAJILLA" class="form-control" type="text" disabled> <br />
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select name="IND_PRENADA" class="form-control" id="IND_PRENADA" value="{{old('IND_PRENADA')}}">
                                ...
                                <option value="ABORTÓ" {{ $vacaprenadaesperma->IND_PRENADA== "ABORTÓ"  ? 'selected' : '' }}>ABORTÓ</option>
                                <option value="NO ABORTÓ" {{ $vacaprenadaesperma->IND_PRENADA== "NO ABORTÓ"  ? 'selected' : '' }}>NO ABORTÓ</option>
                            </select>
                    ...
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="OBS_VACAP" name="OBS_VACAP" placeholder="" rows="2" value="{{old('OBS_VACAP')}}">{{$vacaprenadaesperma->OBS_VACAP}} </textarea>
